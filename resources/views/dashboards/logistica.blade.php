<x-layouts::app :title="__('Panel de Recepción')">
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        <section class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="space-y-1">
                <h1 class="text-2xl font-semibold text-neutral-900 dark:text-neutral-100">Panel de Recepción</h1>
        ...
        <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <div class="rounded-lg border border-neutral-200 p-5 dark:border-neutral-700">
                <h2 class="text-sm font-medium text-neutral-500 dark:text-neutral-400">Órdenes recibidas</h2>
                <p class="mt-2 text-2xl font-semibold text-neutral-900 dark:text-neutral-100">{{ number_format($totalOrdenesRecibidas) }}</p>
            </div>
            ...
            <div class="rounded-lg border border-neutral-200 p-5 dark:border-neutral-700">
                <h2 class="text-sm font-medium text-neutral-500 dark:text-neutral-400">Entregadas</h2>
        ...
        <section class="overflow-hidden rounded-lg border border-neutral-200 dark:border-neutral-700">
            <div class="border-b border-neutral-200 px-5 py-4 dark:border-neutral-700">
                <h2 class="font-medium text-neutral-900 dark:text-neutral-100">Últimas órdenes recibidas</h2>
            </div>
                        ...
                        @forelse ($ultimasOrdenes as $orden)
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-4 py-3 text-right text-sm">
                                    <a href="{{ route('logistica.ordenes-servicio.show', $orden) }}" class="font-medium text-neutral-700 hover:text-neutral-900 dark:text-neutral-300 dark:hover:text-neutral-100">Ver</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
