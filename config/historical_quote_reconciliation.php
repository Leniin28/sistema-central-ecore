    ...
    'cases' => [
        'cot-20260704-0001' => [
            ...
            'manual_refaction_deduplications' => [[
                ...
                'canonical_order_folio' => 'OS-20260704-0001',
                'manual_refaction_id' => 1,
                'canonical_quote_id' => 1,
                'canonical_quote_folio' => 'COT-20260704-0001',
                'cotizacion_item_id' => 9,
                'type' => 'refaccion',
                'description' => 'SSD 256gb',
                'normalized_description' => 'ssd 256gb',
                'quantity' => 1,
                'unit_price' => 869.00,
                'manual_unit_cost' => 719.00,
                'manual_total_cost' => 719.00,
                'expected_item_unit_cost' => 0.00,
                'expected_item_total_cost' => 0.00,
                'confirmed_unit_cost' => 719.00,
                'reason' => 'user_confirmed_same_physical_part',
            ]],
        ],
        'cot-20260728-0001' => [
